...
public class RichPresence {
	...
	public static class Builder {
		...
		public RichPresence build() {
			return new RichPresence(state, details, startTimestamp, endTimestamp, largeImageKey, largeImageText,
		 ...
		 * @param largeImageText Text displayed when a cursor hovers over the large
		 *                       image.
		 *
		 * @return This Builder.
		 */
		 ...
		 * @param smallImageText Text displayed when a cursor hovers over the small
		 *                       image.
		 *
		 * @return This Builder.
		 */
		 ...
		 *
		 * @param joinSecret The unique hashed string for chat invitations and Ask to
		 *                   Join.
		 *
		 * @return This Builder.
		 */
		 ...
		 *
		 * @param instance Whether or not the {@code matchSecret} is a game with a
