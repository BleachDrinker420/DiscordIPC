...
public class User {
	 ...
	 * @param id            user's id
	 * @param avatar        user's avatar hash, or {@code null} if they have no
	 *                      avatar
	 */
	...
	public enum DefaultAvatar {
		BLURPLE("6debd47ed13483642cf09e832ed0bc1b"), GREY("322c936a8c8be1b803cd94861bdfa868"),
		GREEN("dd4dbc0016779df1378e7812eabaa04d"), ORANGE("0e291f67c9274a1abdddeb3fd919cbaa"),
