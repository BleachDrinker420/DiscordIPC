...
public enum PipeStatus {
	 ...
	 * IPCClient in question will become {@link PipeStatus#DISCONNECTED}.
	 */
	CONNECTED,
	...
	/**
	 * Status for when the Pipe has unexpectedly disconnected, either because of an
	 * exception, and/or due to bad data.
	 * <p>
	 *
	 ...
	 * to {@link IPCClient#connect(DiscordBuild...)} can be made to "reconnect" the
	 * IPCClient.
	 */
	DISCONNECTED
}